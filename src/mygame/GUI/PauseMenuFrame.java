...
// Custom JFrame for displaying the pause menu, featuring a sci-fi animated background
// and action buttons.
public class PauseMenuFrame extends JFrame {
    ...
    // Constructor: Initializes the frame, sets up the animated space background,
    // and creates the menu buttons with their respective actions.
    public PauseMenuFrame(ActionListener onResume, ActionListener onRestart, ActionListener onMenu, ActionListener onToggleSound) {
        ...
        // 2. Main Panel with custom paint for background and shape
    ...
    // Configures the ESC key to trigger the resume action.
    ...
    // Creates a custom-styled button with a hexagonal/angled border and hover effects,
    // using a specified base color for the neon border.
    ...
    // Draws a faint, orange-tinted grid overlay for a "tech display" aesthetic.
    ...
    // Data class representing a background star for the parallax effect.
    ...
    // Data class representing a shooting star (meteor) for visual flair.
